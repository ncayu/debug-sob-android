...
public abstract class NineGridLayout extends ViewGroup {
    ...
    private void refresh() {
        ...
        if (size == 1) {
            ...
            RadiusImageView imageView = createImageView(0, url);
    ...
    private RadiusImageView createImageView(final int i, final String url) {
        RadiusImageView imageView = new RadiusImageView(mContext);
     ...
     */
    private void layoutImageView(RadiusImageView imageView, int i, String url, boolean showNumFlag) {
    ...
    protected void setOneImageLayoutParams(RadiusImageView imageView, int width, int height) {
...
//        params.width = width;
     ...
     */
    protected abstract boolean displayOneImage(RadiusImageView imageView, String url, int parentWidth);

    protected abstract void displayImage(RadiusImageView imageView, String url);
